      ...
      <div className="px-20 py-20 space-y-10 flex-grow flex flex-col justify-center">
        ...
        <div className="mt-4 flex items-center">
          ...
          >
            ...
            <option value="jumlahPengajar_asc">By Jumlah Pengajar (Asc)</option>
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="  py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider"></th>
                  </tr>
                </thead>
