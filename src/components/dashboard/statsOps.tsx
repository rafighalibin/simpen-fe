...
export const StatsOps = () => {
  ...
  const {
    isLoading: isLoadingPerubahan,
    error: errorPerubahan,
    data: dataPerubahan,
  } = useQuery({
  ...
  const listPermintaanPerubahan: ReadPermintaanPerubahan[] =
    dataPerubahan.content;
    ...
    <div className="flex-grow grid grid-flow-row-dense grid-cols-2">
      <div className={`${styles.card5} flex-grow p-5 mr-5`}>
        ...
        <div>
          <div
            style={PoppinsBold.style}
            className={`${styles.heading} mt-5 ml-5 mb-5 align-center items-center text-center text-7xl`}
          >
            {listKelas.length}
          </div>
          <div
            style={PoppinsBold.style}
            className={`${styles.heading} mt-3 ml-5 mb-5 align-center items-center text-center text-3xl`}
          >
            Kelas
          </div>
          <div
            style={PoppinsBold.style}
            className={`${styles.heading} mt-3 ml-5 mb-10 align-center items-center text-center`}
          >
            <button
      ...
      <div className={`${styles.card5} p-5`}>
        <div className="flex items-center align-middle">
          <div>
            <FiBookOpen size={32} className="align-middle mt-2 ml-4" />{" "}
            {/* Profile icon */}
          </div>
          <div
            style={PoppinsBold.style}
